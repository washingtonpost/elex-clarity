...
def test_format_atkinson_precincts(atkinson_precincts):
    ...
    assert results["President of the United States"]["timestamp"] == "2020-11-06 13:05:50-05:00"
...
def test_format_bacon_precincts(bacon_precincts):
    ...
    assert "President of the United States" in results.keys()
    assert results["President of the United States"]["precinctsReportingPct"] == 100
    assert results["President of the United States"]["timestamp"] == "2020-11-05 11:39:44-05:00"
...
def test_format_fulton_precincts(fulton_precincts):
    ...
    assert "President of the United States" in results.keys()
    assert results["President of the United States"]["precinctsReportingPct"] == 100
    assert results["President of the United States"]["timestamp"] == "2020-11-10 17:22:39-05:00"
...
def test_format_georgia_counties(georgia_counties):
    ...
    assert results["President of the United States"]["precinctsReportingPct"] == 100
    assert results["President of the United States"]["timestamp"] == "2020-11-20 15:37:06-05:00"
